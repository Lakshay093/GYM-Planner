          ...
          <div className="pt-8">
            ...
            <div className="flex gap-4 animate-scroll">
              ...
              <div className="flex flex-col text-center items-center justify-center bg-[#111111] w-[300px] h-[250px] rounded-xl flex-shrink-0 p-6">
                <img src={Avatars} className="w-[60%] max-w-[120px]" alt="avatars" />
      ...
      <div className="w-4/6 mb-20 gap-20 mx-auto flex items-center">
        <div>
          ...
          <p className="text-xs text-neutral-400 mt-4 w-[400px]">
            ...
            to make fitness accessible, personalized, and effective for everyone.
            No gym? No problem. We help you stay fit – anytime, anywhere.
          </p>
        </div>
        ...
        <div className="w-4/6 mx-auto mt-8 flex justify-between items-start">
          ...
          <div>
            ...
            <ul className="flex gap-2 mt-2">
              <li><a href="/"><img src={Insta} alt="ICON" className="w-4" /></a></li>
              <li><a href="/"><img src={Facebook} alt="ICON" className="w-4" /></a></li>
              <li><a href="/"><img src={Gmail} alt="ICON" className="w-4" /></a></li>
              <li><a href="/"><img src={Twitter} alt="ICON" className="w-4" /></a></li>
            </ul>
          </div>
        </div>
