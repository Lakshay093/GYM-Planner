...
const LandingPage = () => {
    ...
    return ( <
        ...
        /h2> <
        h2 className = "relative font-bold text-5xl bg-gradient-to-b from-[#FFFFFF] to-[#555555] bg-clip-text text-transparent" >
        AI - Powered Workout Plans <
        /h2> <
        p className = "text-xs mt-4 text-[#ffffff72]" > { LandingContent.hero.subheadline } <
        /p>
        ...
        Generate your personalized plan by completing 3 steps. <
        /p>
        ...
        <
        div className = "relative mt-16 mb-8 overflow-hidden" > { /* Gradient overlays */ } <
        div className = "pt-8" >
        <
        ...
        div className = "flex gap-4 animate-scroll" > { /* First set */ } {
            LandingContent.testimonials.entries.map((entry, index) => ( <
                div className = "relative bg-[#111111] w-[300px] h-[250px] p-6 rounded-xl flex-shrink-0 flex flex-col justify-between"
                key = { `first-${index}` } >
                <
                img src = { QuateIcon }
                alt = "Quote"
                ...
                >
                <
                p className = "text-xs font-light text-neutral-400 flex-1 overflow-hidden" > { entry.quote } <
                /p> <
                p className = "text-xs text-right mt-4 text-neutral-400" > { entry.name }, { entry.age }, { entry.profession } <
                /p> <
                /div>
            ))
        }
        ...
        <
        /h6> <
        p className = "mt-2 text-xs text-neutral-400" > { LandingContent.ctaSection.subheadline } <
        /p> <
        ...
        <
        img src = { AIIcon }
        alt = "ICON" / > { isAuthenticated ? "Dashboard" : "Get Started" } <
        /Link> <
        /Button> <
        /div>
        ...
        to make fitness accessible, personalized, and effective
        for everyone.No gym ? No problem.We help you stay fit– anytime, anywhere. <
        /p> <
        /div> <
        ...
        <
        li > < a href = "/" > < img src = { Insta }
        alt = "ICON"
        className = "w-4" / > < /a></li >
        <
        li > < a href = "/" > < img src = { Facebook }
        alt = "ICON"
        className = "w-4" / > < /a></li >
        <
        li > < a href = "/" > < img src = { Gmail }
        alt = "ICON"
        className = "w-4" / > < /a></li >
        <
        li > < a href = "/" > < img src = { Twitter }
        alt = "ICON"
        className = "w-4" / > < /a></li >
        <
        /ul> <
        ...
        &
        copy; 2025 Fitprompt.All rights reserved. <
        /p> <
        /div> <
        /div> <
        /div>
